...
import { Col,
  Container, Row,
  Form, Spinner, Table, ToggleButton, ToggleButtonGroup, Dropdown } from 'react-bootstrap';
import { useEffect, useState } from 'react';
import { useSession } from 'next-auth/react';
import '@/app/analyst/page.css';
...
const ClientDashboard = ({ companies }: Props) => {
  ...
  useEffect(() => {
    ...
    fetchForecast();
  }, [selectedCompanyId, settings, multipliers]);
  ...
  const getCompanyName = (id?: number) => {
    ...
    const company = companiesState.find(c => c.id === id);
        ...
        <Row className="full-height">
          ...
          <Col xs={12} sm={8} md={9} lg={10} className="right-section">
            <div className="dashboard">
              <h2 className="h2">Financial Model</h2>
              <Table borderless responsive className="fixed">
                <thead>
                  {loading && (
                    <tr>
                      <td colSpan={15}>
              ...
              <Table borderless responsive className="fixed">
                ...
                <tbody className="font">
                  ...
                  <tr>
                    <td className="left">Scenario 1 - Residual Effect</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                  ...
                  <tr>
                    <td className="left">Scenario 2 - Stress Effect</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                  ...
                  <tr>
                    <td className="left">Scenario 2 - Residual Effect</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                  ...
                  <tr>
                    <td className="left">Scenario 3 - Residual Effect</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                  ...
                  <tr>
                    <td className="left">Scenario 4 - Residual Effect</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                  ...
                  <tr>
                    <td className="left">Scenario 5 - Residual Effect</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                  ...
                  <tr>
                    <td className="left">Scenario 3 - Stress Effect</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                  ...
                  <tr>
                    <td className="left">Scenario 4 - Stress Effect</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                  ...
                  <tr>
                    <td className="left">Scenario 5 - Stress Effect</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
                    <td aria-label="blank" colSpan={1}>&nbsp;</td>
