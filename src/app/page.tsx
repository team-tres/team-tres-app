...
const Home = () => (
  <main>
    <Container id="landing-page" fluid className="py-3">
      <div
        style={{ position: 'relative', width: '100%', height: '300px', top: '100px', backgroundImage: 'url("/ocean.jpg")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', }}
      >
        <Row
        ...
        >
          <Col className="d-flex flex-column justify-content-center">
            <h1 style={{ fontFamily: 'Open sans', color: 'white', textAlign: 'center' }}>
              ...
              The future is found in the past. – Molokaʻi: Future of a Hawaiian Island,
              Sustainability Conference, July 2009
            </h1>
          </Col>
        </Row>
      </div>
    <Row  className="align-items-center justify-content-center" >
        <Col Col className="d-flex flex-column justify-content-center" style={{ padding: '200px' }}>
          ...
          In cooperation with 
          <a href="https://www.spirehawaii.com/" target="_blank" rel="noopener noreferrer" style={{ fontWeight: 'bold', color: '#00243D', textDecoration: 'none' }}> Spire </a>
