...
import { ToggleButtonGroup, ToggleButton, Container, Table, Spinner, Form } from 'react-bootstrap';
import './page.css';
        ...
        <Table borderless responsive>
          ...
          <tbody className="font">
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="revenue" value={settings.revenue === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('revenue', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%' }} value={(multipliers.revenue * 100)} onChange={(e) => handleMultiplierChange('revenue', e.target.value)} />
                %
              </td>
              {forecast.map((entry) => (
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="costOfContracting" value={settings.costOfContracting === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('costOfContracting', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.costOfContracting * 100)} onChange={(e) => handleMultiplierChange('costOfContracting', e.target.value)} />
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="overhead" value={settings.overhead === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('overhead', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.overhead * 100)} onChange={(e) => handleMultiplierChange('overhead', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="salariesAndBenefits" value={settings.salariesAndBenefits === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('salariesAndBenefits', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.salariesAndBenefits * 100)} onChange={(e) => handleMultiplierChange('salariesAndBenefits', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="rentAndOverhead" value={settings.rentAndOverhead === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('rentAndOverhead', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.rentAndOverhead * 100)} onChange={(e) => handleMultiplierChange('rentAndOverhead', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="depreciationAndAmortization" value={settings.depreciationAndAmortization === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('depreciationAndAmortization', value)} size="sm">
                  <ToggleButton variant="success" id="tbg-depreciationAndAmortization-1" value={1} className="button">
                    M
                  </ToggleButton>
                  <ToggleButton variant="success" id="tbg-depreciationAndAmortization-2" value={2} className="button">
                    A
                  </ToggleButton>
                </ToggleButtonGroup>
              </td>
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.depreciationAndAmortization * 100)} onChange={(e) => handleMultiplierChange('depreciationAndAmortization', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="interest" value={settings.interest === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('interest', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.interest * 100)} onChange={(e) => handleMultiplierChange('interest', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr className="bold">
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="profitFromOperations" value={settings.profitFromOperations === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('profitFromOperations', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.profitFromOperations * 100)} onChange={(e) => handleMultiplierChange('profitFromOperations', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="interestIncome" value={settings.interestIncome === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('interestIncome', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.interestIncome * 100)} onChange={(e) => handleMultiplierChange('interestIncome', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="interestExpense" value={settings.interestExpense === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('interestExpense', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.interestExpense * 100)} onChange={(e) => handleMultiplierChange('interestExpense', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="gainOnDisposalOfAssets" value={settings.gainOnDisposalOfAssets === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('gainOnDisposalOfAssets', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.gainOnDisposalOfAssets * 100)} onChange={(e) => handleMultiplierChange('gainOnDisposalOfAssets', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="otherIncome" value={settings.otherIncome === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('otherIncome', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.otherIncome * 100)} onChange={(e) => handleMultiplierChange('otherIncome', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="incomeTaxes" value={settings.incomeTaxes === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('incomeTaxes', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.incomeTaxes * 100)} onChange={(e) => handleMultiplierChange('incomeTaxes', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
          ...
          <tbody className="font">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="cashAndCashEquivalents" value={settings.cashAndCashEquivalents === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('cashAndCashEquivalents', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.cashAndCashEquivalents * 100)} onChange={(e) => handleMultiplierChange('cashAndCashEquivalents', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="accountsReceivable" value={settings.accountsReceivable === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('accountsReceivable', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.accountsReceivable * 100)} onChange={(e) => handleMultiplierChange('accountsReceivable', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="inventory" value={settings.inventory === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('inventory', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.inventory * 100)} onChange={(e) => handleMultiplierChange('inventory', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="propertyPlantAndEquipment" value={settings.propertyPlantAndEquipment === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('propertyPlantAndEquipment', value)} size="sm">
                  <ToggleButton variant="success" id="tbg-propertyPlantAndEquipment-1" value={1} className="button">
                    M
                  </ToggleButton>
                  <ToggleButton variant="success" id="tbg-propertyPlantAndEquipment-2" value={2} className="button">
                    A
                  </ToggleButton>
                </ToggleButtonGroup>
              </td>
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.propertyPlantAndEquipment * 100)} onChange={(e) => handleMultiplierChange('propertyPlantAndEquipment', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="investment" value={settings.investment === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('investment', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.investment * 100)} onChange={(e) => handleMultiplierChange('investment', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="accountsPayable" value={settings.accountsPayable === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('accountsPayable', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.accountsPayable * 100)} onChange={(e) => handleMultiplierChange('accountsPayable', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="currentDebtService" value={settings.currentDebtService === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('currentDebtService', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.currentDebtService * 100)} onChange={(e) => handleMultiplierChange('currentDebtService', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="taxesPayable" value={settings.taxesPayable === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('taxesPayable', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.taxesPayable * 100)} onChange={(e) => handleMultiplierChange('taxesPayable', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              <td className="left">Debt Service</td>
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="longDebtService" value={settings.longDebtService === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('longDebtService', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.longDebtService * 100)} onChange={(e) => handleMultiplierChange('longDebtService', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="loansPayable" value={settings.loansPayable === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('loansPayable', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.loansPayable * 100)} onChange={(e) => handleMultiplierChange('loansPayable', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="equityCapital" value={settings.equityCapital === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('equityCapital', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.equityCapital * 100)} onChange={(e) => handleMultiplierChange('equityCapital', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
            ...
            <tr>
              ...
              <td className="green-type">
                <ToggleButtonGroup type="radio" name="retainedEarnings" value={settings.retainedEarnings === 'multiplier' ? 1 : 2} onChange={(value) => handleSettingChange('retainedEarnings', value)} size="sm">
              ...
              <td className="green-input">
                <Form.Control type="number" className="button" style={{ width: '100%', display: 'inline-block' }} value={(multipliers.retainedEarnings * 100)} onChange={(e) => handleMultiplierChange('retainedEarnings', e.target.value)} />
                <span style={{ display: 'inline-block' }}>%</span>
              </td>
              {forecast.map((data) => (
                <td className="grey-bg">
